...
async def render_email(request: Request):
    return templates.TemplateResponse(request=request, name="email.html", context={"request": request})

@router.get("/crafter")
async def render_crafter(request: Request):
    return templates.TemplateResponse(request=request, name="crafter.html", context={"request": request})

@router.get("/orders")
async def render_orders(request: Request):
    return templates.TemplateResponse(request=request, name="orders.html", context={"request": request})
